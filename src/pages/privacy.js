...
export default function Privacy() {
  return (
    <div>
      <Root>
        <h3 style={{textAlign:'center',marginTop:'40px'}}>Privacy Policy</h3>
        <section id="features">
          <div className="container">
            <div className="row feature-item mt-5">
              <div className="col-lg-12 wow fadeInUp pt-4 pt-lg-0 order-2 order-lg-1">
                <h5>Overview</h5>
                <p>
                  This Privacy Policy applies to all of the products, services
                  and websites offered by GCBUYING. In addition, where more
                ...
                <h5>Information we collect and how we use them</h5>
                <p>
                ...
                <p>
                  When you sign up for any GCBUYING Service or promotion that
                  requires registration, we ask you for personal information
                  (such as your name, email address and an account password). We
                  typically do not store this information and when we do, we
                  maintain the data in encrypted form on secure servers. We may
                  combine the information you submit under your account with
                  information from other third parties in order to provide you
                ...
                <h5>
                  When you access GCBUYING, our servers automatically record
                  information that your browser sends whenever you visit a
                  website.
                </h5>
                <h5>User communications</h5>
                <p>
                  When you send email or other communications to GCBUYING, we
                ...
                <h5>&nbsp;Other sites</h5>
                <p>
                  This Privacy Policy applies to GCBUYING only. We do not
                  ...
                  solicit personal information from you. GCBUYING processes
                  personal information for the purposes described
                </p>
                <p>Data policy</p>
                <p>
                  GCBUYING &nbsp;Data Protection Policy refers to our commitment
                  to treat information of employees, customers, stakeholders and
                ...
                <p>
                  ...
                  following rules apply. Our data will be:
                </p>
                <ul>
                ...
                <ul>
                  <li>
                    Communicated informally • Stored for more than a specified
                    amount of time
                  </li>
                  <li>
